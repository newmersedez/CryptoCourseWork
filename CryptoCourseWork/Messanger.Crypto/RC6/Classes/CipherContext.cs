...
using Messanger.Crypto.RC6.Interfaces;
using Messanger.Crypto.RC6.Utils;

namespace Messanger.Crypto.RC6.Classes
{
    ...
    public sealed class CipherContext
    {
        ...
        public CipherContext(EncryptionMode mode, byte[] vector, string param)
        {
            _mode = mode;
